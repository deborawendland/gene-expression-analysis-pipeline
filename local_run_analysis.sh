...
if [ $(ls -1 ./Data/samples/*.fastq 2>/dev/null | wc -l) = 0 ]; then 
...
if [ $(ls -1 ./Data/reference_genome_hg38/*.fna 2>/dev/null | wc -l) = 0 ]; then 
...
if [ $(ls -1 ./Data/reference_genome_hg38/*.gtf 2>/dev/null | wc -l) = 0 ]; then 
